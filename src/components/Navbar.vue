    ...
    <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 bg-white border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <!-- mobile hamburger -->
                <div class="inline-block lg:hidden flex items-center mr-4 text-gray-700">
                  <button class="hover:text-purple-600 hover:border-white focus:outline-none navbar-burger" @click="toggleSidebar()">
                ...
                <div class="relative text-gray-500">
                  <input type="search" name="serch" placeholder="Buscar ..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
